...
def main():
    ...
    with col2:
        ...
        st.button("📋 Real Sample", on_click=load_real_sample)
        st.button("📋 Fake Sample", on_click=load_fake_sample)
